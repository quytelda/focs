...
/* Transformations */
void dl_map(struct double_list * list, map_fn_t fn);
...
bool dl_any(struct double_list * list, pred_fn_t p);
bool dl_all(struct double_list * list, pred_fn_t p);

/* Filtering */
bool dl_filter(struct double_list * list, pred_fn_t p);
bool dl_drop_while(struct double_list * list, pred_fn_t p);
bool dl_take_while(struct double_list * list, pred_fn_t p);
